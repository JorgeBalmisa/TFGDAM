...
public class ClienteController extends BaseControllerImpl<Cliente, ClienteServiceImpl> {
    ...
    public ResponseEntity<?> update(@PathVariable Long clienteId, @RequestBody Cliente clienteActualiz) {
        Cliente updatedCliente = servicio.updateCliente(clienteId, clienteActualiz);
